...
if test "$yimmy_solarized" = "true"
  ...
  set -e LSCOLORSxterm*font: terminus-12
endxterm*font: terminus-12
...
function fish_prompt
  ...
  if not set -q __fish_prompt_charxterm*font: terminus-12
    switch (id -u)
      case 0
  ...
  # Line 1
  echo -n $red'┌'$green$USER$white'@'$green$__fish_prompt_hostname $gray(pwd)$normal
  __fish_git_prompt
